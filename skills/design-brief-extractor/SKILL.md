---
name: design-brief-extractor
description: Extract and structure design briefs from messy source material. Use this skill when users ask to extract a design brief from notes, product context, stakeholder input, screenshots, research, or existing requirements, or when they need unclear design direction turned into a usable brief.
---
...
Extract comprehensive, well-structured design briefs from incomplete or unstructured source material. This skill helps designers and product teams turn notes, conversations, requirements, research, screenshots, and stakeholder input into clear briefs that define scope, goals, constraints, and success criteria.
...
When source material is available, synthesize it directly into the design brief template. When key fields are missing, mark them as `Unknown` or `Needs clarification` instead of inventing details.

The bundled generator script can still be used when starting from scratch:

```bash
scripts/generate_brief.sh
```

Use the script or the extraction workflow to produce a comprehensive design brief covering:
...
### When to Extract a Design Brief

**Use this skill for:**
- Turning stakeholder notes into a design brief
- Extracting design requirements from a PRD or product plan
- Converting screenshots, UX feedback, or research notes into design direction
- Reconciling scattered project context into a single design artifact
- Identifying missing information before design work starts

**Skip for:**
- Minor UI tweaks
- Bug fixes
- Small iterations on existing designs
- Cases where a complete, validated brief already exists
