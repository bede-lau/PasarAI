...
**Find the specifications.** Specs are the source of truth for functional tests. Search in order: `AGENTS.md`/`AGENTS.md` in root, `specs/`, `docs/`, `spec/`, `design/`, `architecture/`, `adr/`, then `.md` files in root. Record the paths.
...
>
> **3. Review development history** — Point me to exported AI chat history (Codex, Gemini, ChatGPT exports, Codex transcripts) and I'll mine it for design decisions, incident reports, and quality discussions that should be in QUALITY.md. Good for: grounding scenarios in real project history instead of inference.
>
